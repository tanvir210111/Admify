              ...
              {[
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    {" "}
                    <span
                      className={`px-2 py-1 text-xs rounded-full ${app.status === "New" ? "bg-blue-500/20 text-blue-400" : app.status === "Interview Scheduled" ? "bg-yellow-500/20 text-yellow-400" : "bg-slate-700 text-slate-300"}`}
                    >
                      {" "}
                      {app.status}{" "}
                    </span>{" "}
